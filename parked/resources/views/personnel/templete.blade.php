        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                <a class="navbar-brand" href="index.html">
                        ...
                        <img class="img-fluid" src="assets/images/logo-personnel.png" alt="">
                        </figure>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto">
                        <li class="nav-item ">
                            <a class="nav-link scroll" href="{{route ('place.index')}}">Accueil</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link scroll" href="{{url ('ListR')}}">Voir les reservations</a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu list-unstyled hotline-dropdown" aria-labelledby="navbarDropdownMenu">
                                <ul class="dropdown-menu-list list-unstyled" id="hotline-dropdown-list">
                                    <li class="nav-item"><a class="dropdown-item scroll hotline-menu" href="{{url ('/addPlace')}}">Ajouter place</a></li>
                                    <li class="nav-item"><a class="dropdown-item scroll hotline-menu" href="{{route ('place.index')}}">Voir Place</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
                    <div class="login-outer-div">
                        <ul class="login-listing m-0 p-0">
                            ...
                            @else
                            <li class="list-unstyled d-lg-inline-block"><a class="nav-link scroll" href="login.html"> {{ Auth::user()->name }}</a></li>
        ...
        <div class="row position-relative">
            <div class="col-xl-5 col-lg-4 col-md-5 col-sm-6 text-sm-left text-center">
                <div class="footer-logo-content">
                    ...
                    <p class="text-size-16 mb-lg-4 mb-md-3 mb-3">Partie permettant aux personnels de gérer les reservations et les places en effectuant un ajout ou suppréssion en cas de besoin.</p>
            ...
            <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 d-lg-block d-md-none d-sm-none d-none">
                <div class="footer-links-content">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li><i class="fas fa-caret-right"></i><a class="text-decoration-none font-weight-normal" href="index.html">Accuel</a></li>
                        <li><i class="fas fa-caret-right"></i><a class="text-decoration-none font-weight-normal" href="team.html">Voir les reservations</a></li>
                        <li><i class="fas fa-caret-right"></i><a class="text-decoration-none font-weight-normal" href="services.html">gestion des places</a></li>
                        <li><i class="fas fa-caret-right"></i><a class="text-decoration-none font-weight-normal" href="login.html">Login</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-6 d-md-block d-sm-none d-none">
                <div class="footer-support-content">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li><i class="fas fa-caret-right"></i><a class="text-decoration-none font-weight-normal" href="https://designingmedia.com/support">Ajouter place</a></li>
                        <li><i class="fas fa-caret-right"></i><a class="text-decoration-none font-weight-normal" href="contact.html">Supprimer place</a></li>
                        </ul>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 text-sm-left text-center d-sm-block d-none">
                <div class="footer-info-content">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li><span class="font-weight-bold">Phone:</span><a class="text-decoration-none font-weight-normal" href="tel:+12345678900"> +221 77 837 93 97</a></li>
                        <li><span class="font-weight-bold">Fax:</span><a class="text-decoration-none font-weight-normal" href="#"> +333 973 69 94</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="footer-bar-content w-100">
                <p class="text-size-16 mb-0">Copyright ©2023 Hotline.com All Rights Reserved</p>
            </div>
        </div>
    </div>
</div>
