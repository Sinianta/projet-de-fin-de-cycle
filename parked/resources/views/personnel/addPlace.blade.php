        ...
        <div class="row">
            <div class="col-xl-5 col-lg-6 col-md-6 col-sm-12 order-xl-1 order-lg-1 order-md-1 order-sm-2 order-2 text-md-left text-center">
                <div class="customer-base-section-text position-relative">
                    ...
                    <h2 class="mb-lg-4 mb-md-3 mb-2">Ajouter des places dans le systeme pour votre parking </h2>
                    <p>Saisissez bien l'indice de la place qui comprendre un lettre Alphabet suivid d'un trait et d'un numéro</p>
                    <div class="contact-form">
                        <form  method="POST" action="{{ route('place.store') }}">
                            @csrf
                            <div class="form-group">
                                <label for="date_entrer">Indice de la place:* </label>
                                <input type="text" class="form-control"  name="numero" id="numero" placeholder="A-12">
                            </div>
                            <div class="form-group" style="display: none">
                                <input type="text" class="form-control"  name="disponibilite" id="disponibilite" value="Libre">
                            </div>
                            <div class="form-group" style="display: none">
                                <input type="number" class="form-control"  name="parking_id" id="parking_id" value="{{Auth::user()->parking_id}}">
                            </div>
